...
![Leaderboard](https://res.cloudinary.com/dsrekt1mo/image/upload/c_pad,b_auto:predominant,fl_preserve_transparency/v1711483533/Screenshot_2024-03-26_at_1.00.24_PM_f5704e_cccqmg.jpg?_s=public-apps)
*The current leaderboard of my "Where's Alex Honnold" photo tagging app...*
...
The tutorial I chose was called **Real-Time Messenger Clone: Next.js 13, React, Tailwind, Prisma, MongoDB, NextAuth, Pusher (2023)** by [AntonioErdeljac](https://github.com/AntonioErdeljac). You can view his original repo [here](https://github.com/AntonioErdeljac/next13-messenger). It's a fairly simple application that allows anyone who signs up to message anyone else with an account. Conversations are updated in realtime for all users.

![Full Stack Messenger Clone](https://www.codewithantonio.com/_next/image?url=https%3A%2F%2Futfs.io%2Ff%2Fe263eba0-1fd5-411d-b407-fc73e1d1be5a-jrwdgh.jpg&w=3840&q=75)
*The tutorial I chose to follow*
...
![Pusher Cluster Location](https://res.cloudinary.com/dsrekt1mo/image/upload/v1711485331/Pusher_Screenshot_xmp8ub.png)
...
![Screenshot of the finished messaging interface](https://res.cloudinary.com/dsrekt1mo/image/upload/v1711495806/conversation_fcnglt.png)
*The finished product. You can view the live site [here](https://messaging-app-azure.vercel.app/).*
...
*For anyone interested, I have a more complete list of changes from the original repo [here](https://github.com/columk1/messaging-app/blob/main/CHANGELOG.md).*