...
_The current leaderboard of my "Where's Alex Honnold" photo tagging app..._
...
![Full Stack Messenger Clone](https://res.cloudinary.com/dsrekt1mo/image/upload/w_1000/q_auto/Messenger_Clone_Antonio_rumcoy.jpg)
_The tutorial I chose to follow_
...
_The finished product. You can view the live site [here](https://messaging-app-azure.vercel.app/)._
...
_For anyone interested, I have a more complete list of changes from the original repo [here](https://github.com/columk1/messaging-app/blob/main/CHANGELOG.md)._
