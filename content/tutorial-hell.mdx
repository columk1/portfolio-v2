...
_The finished product. Visit the [site](https://messaging-app-azure.vercel.app/)._
...
_For anyone interested, I have a more complete [list of changes](https://github.com/columk1/messaging-app/blob/main/CHANGELOG.md) from the original repo._
